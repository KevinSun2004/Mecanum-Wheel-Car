...
{
    if (v1 >= 0) {
        HAL_GPIO_WritePin(Motor1_m1_Port, Motor1_m1_Pin, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(Motor1_m2_Port, Motor1_m2_Pin, GPIO_PIN_SET);
    } else {
        HAL_GPIO_WritePin(Motor1_m1_Port, Motor1_m1_Pin, GPIO_PIN_SET);
        HAL_GPIO_WritePin(Motor1_m2_Port, Motor1_m2_Pin, GPIO_PIN_RESET);
    }
    __HAL_TIM_SetCompare(&Motor1_PWM_TIM, Motor1_PWM_CH, 200 * fabs(v1));

    if (v2 >= 0) {
        HAL_GPIO_WritePin(Motor2_m1_Port, Motor2_m1_Pin, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(Motor2_m2_Port, Motor2_m2_Pin, GPIO_PIN_SET);
    } else {
        HAL_GPIO_WritePin(Motor2_m1_Port, Motor2_m1_Pin, GPIO_PIN_SET);
        HAL_GPIO_WritePin(Motor2_m2_Port, Motor2_m2_Pin, GPIO_PIN_RESET);
    }
    __HAL_TIM_SetCompare(&Motor2_PWM_TIM, Motor2_PWM_CH, 200 * fabs(v2));

    if (v3 >= 0) {
        HAL_GPIO_WritePin(Motor3_m1_Port, Motor3_m1_Pin, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(Motor3_m2_Port, Motor3_m2_Pin, GPIO_PIN_SET);
    } else {
        HAL_GPIO_WritePin(Motor3_m1_Port, Motor3_m1_Pin, GPIO_PIN_SET);
        HAL_GPIO_WritePin(Motor3_m2_Port, Motor3_m2_Pin, GPIO_PIN_RESET);
    }
    __HAL_TIM_SetCompare(&Motor3_PWM_TIM, Motor3_PWM_CH, 200 * fabs(v3));

    if (v4 >= 0) {
        HAL_GPIO_WritePin(Motor4_m1_Port, Motor4_m1_Pin, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(Motor4_m2_Port, Motor4_m2_Pin, GPIO_PIN_SET);
    } else {
        HAL_GPIO_WritePin(Motor4_m1_Port, Motor4_m1_Pin, GPIO_PIN_SET);
        HAL_GPIO_WritePin(Motor4_m2_Port, Motor4_m2_Pin, GPIO_PIN_RESET);
    }
